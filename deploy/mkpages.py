...
<p>Цены за дом %(size)s м с доставкой до 50 км и сборкой на участке. Разница между проектами —
...
входная дверь, черновой пол, фундамент и сборка. <b>Тёплый контур</b> добавляет каменную вату,
...
доставка материалов — 300 ₽ за километр сверх первых 50 км.</p>
<div class="tw"><table>
...
<p>Утеплитель — каменная вата в плитах, её укладывают враспор между стойками каркаса. Чем толще
...
Поэтому утепление — это не только вата: вместе с ним дорожает и сам каркас, и это уже учтено
в калькуляторе.</p>
<h2>Что ещё влияет на тепло</h2>
<ul>
  <li><b>Пароизоляция изнутри и ветро-влагозащита снаружи.</b> Без них вата намокает и перестаёт греть. Входят в цену.</li>
...
<p><b>Тёплый контур</b> — плюс каменная вата, пароизоляция, вагонка внутри и плита OSB-3 15 мм
...
<ul>
  ...
  <li><b>Утепление.</b> 100 мм в базе, 150–250 мм — доплата за вату и за более толстый каркас.</li>
  ...
  <li><b>Доставка.</b> 300 ₽ за километр сверх 50 км от производства.</li>
</ul>
...
а оплата идёт по окончании работ — не мы, а вы решаете, когда работа принята.</p>
...
def size_pages(houses):
    ...
    for s in order:
        ...
        desc = ('Каркасный дом %s м (%s м²) под ключ: %d проекта на выбор, цены от %s. '
                'Планировка на ваш вкус, сборка на участке, оплата по окончании работ.'
...
QA = [
 ('Можно ли жить в каркасном доме зимой?',
  'Да, если выбрать утепление от 150 мм. В базовую цену входит каменная вата 100 мм — это дача на тёплый сезон. Для зимы в средней полосе берут 200 мм, для Урала и Сибири — 250 мм с перекрёстным каркасом.'),
 ('Строите ли вы зимой?',
 ...
 ('Входит ли сборка в стоимость?',
  'Да. И дом, и модуль собирает наша бригада на вашем участке — сборка входит в цену. Отдельно считается только доставка: 300 ₽ за километр сверх первых 50 км.'),
 ('Куда вы доставляете?',
